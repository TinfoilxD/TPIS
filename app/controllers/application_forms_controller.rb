class ApplicationFormsController < ApplicationController
  ...
  def application_form_params
    params.require(:application_form).permit(:candidate_id, :training_center_id, :course_id, :course_type_id, :aha_instructor_motivation,
                                             ...
                                             :merica_cross_check, :ns_council_other, :course_start_date, :course_address, :state_id, :course_city,
                                             :course_zipcode, :align_w_tp_check)
  end
end
