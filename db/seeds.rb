...
Candidate.create(email:'DanceEmiliaDance@aol.com', first_name: 'Emilia', last_name: 'Cortez', address: '6 Kings Manor', phone: '210-555-1213', state:'Texas', zipcode: '77010', country: 'United States', occupation: 'Nurse' , alignment_type_id: '1')
Candidate.create(email:'pressurepointprince@yahoo.com', first_name: 'Blaivin', last_name: 'DiMassio', address: '4401 Wheeler St.', phone: '832-555-2111', state:'Texas', zipcode: '77004', country: 'United States', occupation: 'Masseuse' , alignment_type_id: '1')
Candidate.create(email:'yogamaster65@gmail.com', first_name: 'Vincent', last_name: 'LeEngardien', address: '123 Cullen', phone: '832-555-6640', state:'Texas', zipcode: '76950', country: 'United States', occupation: 'Yoga Instructor' , alignment_type_id: '1')
Candidate.create(email:'conventionalking@gmail.com', first_name: 'Julio', last_name: 'Villanueva', address: '987 Spanish Trail', phone: '832-555-3333', state:'Texas', zipcode: '77099', country: 'United States', occupation: 'Healer' , alignment_type_id: '1')
...
# 16-20
Candidate.create(email:'SandraEsp333@gmail.com', first_name: 'Sandra', last_name: 'Espinoza', address: '301 Panick Rd', phone: '281-555-9919', state:'Texas', zipcode: '77400', country: 'United States', occupation: 'Masseuse' , alignment_type_id: '1')
Candidate.create(email:'ShandyCheeks@gmail.com', first_name: 'Shaundra', last_name: 'Smith', address: '33 Elgin Rd.', phone: '713-555-2221', state:'Texas', zipcode: '77003', country: 'United States', occupation: 'Nurse' , alignment_type_id: '1')
Candidate.create(email:'waxpoetic42@gmail.com', first_name: 'Timothy', last_name: 'Tactin', address: '14002 Skramz Ave.', phone: '713-555-9499', state:'Texas', zipcode: '77010', country: 'United States', occupation: 'Secretary' , alignment_type_id: '1')
Candidate.create(email:'XtremeGus@yahoo.com', first_name: 'Gustavo', last_name: 'Sorola', address: '636 Congress Ave', phone: '713-555-5332', state:'Texas', zipcode: '77099', country: 'United States', occupation: 'Cleric' , alignment_type_id: '1')
Candidate.create(email:'YogaChris@gmail.com', first_name: 'Christopher', last_name: 'Walz', address: '7005 Drive Road', phone: '832-555-3001', state:'Texas', zipcode: '78405', country: 'United States', occupation: 'Masseuse' , alignment_type_id: '1')

# 21-25
Candidate.create(email:'HolyHolly@gmail.com', first_name: 'Holly', last_name: 'Hammond', address: '2224 Skillfold Dr.', phone: '832-555-2919', state:'Texas', zipcode: '77402', country: 'United States', occupation: 'Nurse' , alignment_type_id: '1')
Candidate.create(email:'iloveyoga333@yahoo.com', first_name: 'Xavier', last_name: 'Cardenas', address: '539 Westscott Rd.', phone: '713-555-6642', state:'Texas', zipcode: '78480', country: 'United States', occupation: 'Masseuse' , alignment_type_id: '1')
Candidate.create(email:'marksand@gmail.com', first_name: 'Markus', last_name: 'LaPorte', address: '9931 Barcelona Rd.', phone: '281-555-3311', state:'Texas', zipcode: '77480', country: 'United States', occupation: 'Instructor' , alignment_type_id: '1')
Candidate.create(email:'bestinthewest12321@aol.com', first_name: 'Elizabeth', last_name: 'Zertuche', address: '5530 Quahog Dr.', phone: '713-555-2000', state:'Texas', zipcode: '77004', country: 'United States', occupation: 'Nurse' , alignment_type_id: '1')
Candidate.create(email:'diariesofaCoco@aol.com', first_name: 'Coco', last_name: 'Diaz', address: '404 Error Rd.', phone: '281-555-5555', state:'Texas', zipcode: '77010', country: 'United States', occupation: 'Masseuse' , alignment_type_id: '1')

# 26-30
Candidate.create(email: 'wayne.johnson@yahoo.com', first_name: 'Wayne' , last_name: 'Johnson', address: '3014 Neverland Lane', phone: '832-434-2535' ,  state: 'Texas' , zipcode: '77204' , country: 'United States' , occupation: 'Physical Trainer' , alignment_type_id: '2')
Candidate.create(email: 'raygun25@yahoo.com', first_name: 'Ray' , last_name:'Gunnanham', address: '121 Sellen Road' , phone: '832-553-3257'  , state: 'Texas' , zipcode: '77459' , country: 'United States' , occupation: 'Masseuse' , alignment_type_id: '1')
Candidate.create(email: 'topdog24245@yahoo.com', first_name: 'David', last_name: 'Hatchet', address: '1043 Given St' , phone: '832-543-3042' , fax: '281-241-2329' , state: 'Texas' , zipcode: '77084' , country: 'United States' , occupation: 'Masseuse' , alignment_type_id: '1')
Candidate.create(email: 'yumi.yswami@yahoo.com', first_name: 'Yumi', last_name: 'Yswami', address: '231 Baley Court'  , phone: '281-545-2210' , state: 'Texas', zipcode: '77406' , country: 'United States' , occupation: 'Massage Therapist' , alignment_type_id: '2')
Candidate.create(email: 'diamondmerrs@yahoo.com', first_name: 'Diamond', last_name: 'Merrs', address: '834 Lime Lane', phone: '832-555-64364', state:'Texas', zipcode: '77459', country: 'United States', occupation: 'Nurse' , alignment_type_id: '2')

# 31-35
Candidate.create(email: 'lindaramos@yahoo.com', first_name: 'Linda', last_name: 'Ramos', address: '303 Viren St' , phone: '713-534-2034' ,  state: 'Texas' , zipcode: '77048' , country: 'United States' , occupation: 'Massage Therapist' , alignment_type_id: '3')
Candidate.create(email: 'carrieturner@yahoo.com', first_name: 'Carrie' , last_name:'Turner'  , address: '777 Heaven Lane' , phone: '832-455-7084'  , state: 'Texas' , zipcode: '77102' , country: 'United States' , occupation: 'Physical Trainer' , alignment_type_id: '3')
Candidate.create(email: 'izzesaturn@yahoo.com', first_name: 'Izze' , last_name: 'Turner' , address: '4574 Crane St' , phone: '832-554-5023' , fax: '281-243-2429' , state: 'Texas' , zipcode: '77684' , country: 'United States' , occupation: 'Nurse' , alignment_type_id: '1')
Candidate.create(email: 'yoland.adams@gmail.com', first_name: 'Yoland' , last_name: 'Adams' , address: '2673 Ray Lane'  , phone: '281-455-2430' , state: 'Texas', zipcode: '77423' , country: 'United States' , occupation: 'Massage Therapist' , alignment_type_id: '2')
Candidate.create(email: 'stacie.hamiltion@gmail.com', first_name: 'Stacie', last_name: 'Hamiltion', address: '542 Hamburger Lane', phone: '832-545-5304', state:'Texas', zipcode: '77246', country: 'United States', occupation: 'Nurse' , alignment_type_id: '4')

# 36-40
Candidate.create(email: 'vannessa.adams@gmail.com', first_name: 'Vannessa' , last_name: 'Adams', address: '7437 Peoples Lane' , phone: '713-434-4038' ,  state: 'Texas' , zipcode: '77698' , country: 'United States' , occupation: 'Massage Therapist' , alignment_type_id: '1')
Candidate.create(email: 'rachel.ewagami@gmail.com', first_name: 'Rachel' , last_name:'Ewagami'  , address: '643 Uma St' , phone: '832-355-6545'  , state: 'Texas' , zipcode: '77402' , country: 'United States' , occupation: 'Physical Trainer' , alignment_type_id: '3')
Candidate.create(email: 'freddiegoldmen@hotmail.com', first_name: 'Freddie' , last_name: 'Goldmen' , address: '434 Mix Lane' , phone: '832-855-3320' , fax: '281-241-2949' , state: 'Texas' , zipcode: '77002' , country: 'United States' , occupation: 'Masseuse' , alignment_type_id: '3')
Candidate.create(email: 'josh.lemon@hotmail.com', first_name: 'Josh' , last_name: 'Lemon' , address: '534 Rails St'  , phone: '281-655-2040' , state: 'Texas', zipcode: '77506' , country: 'United States' , occupation: 'Masseuse' , alignment_type_id: '2')
Candidate.create(email: 'petricia.sinclair@yahoo.com', first_name: 'Petricia', last_name: 'Sinclair', address: '5236 Damon Road', phone: '832-553-4200', state:'Texas', zipcode: '77206', country: 'United States', occupation: 'Nurse' , alignment_type_id: '3')

# 41-45
Candidate.create(email: 'haleymcduff@yahoo.com', first_name: 'Haley' , last_name: 'McDuff', address: '3053 Kirby Road' , phone: '713-545-2038' ,  state: 'Texas' , zipcode: '77067' , country: 'United States' , occupation: 'Massage Therapist' , alignment_type_id: '1')
Candidate.create(email: 'gregory.banes@gmail.com', first_name: 'Gregory' , last_name:'Banes'  , address: '923 Hollow Lane' , phone: '832-932-2084'  , state: 'Texas' , zipcode: '77102' , country: 'United States' , occupation: 'Nurse' , alignment_type_id: '4')
Candidate.create(email: 'tamma.negan@gmail.com', first_name: 'Tamma' , last_name: 'Negan' , address: '8325 Telephone Road' , phone: '832-623-3030' , fax: '281-934-2939' , state: 'Texas' , zipcode: '77044' , country: 'United States' , occupation: 'Masseuse' , alignment_type_id: '1')
Candidate.create(email: 'alicia.freeman@gmail.com', first_name: 'Alicia' , last_name: 'Freeman' , address: '334 Emerald Road'  , phone: '281-435-2010' , state: 'Texas', zipcode: '77436' , country: 'United States' , occupation: 'Nurse' , alignment_type_id: '2')
Candidate.create(email: 'umi.omigowa@gmail.com', first_name: 'Umi', last_name: 'Omigowa', address: '1504 Wale Road', phone: '832-345-3230', state:'Texas', zipcode: '77406', country: 'United States', occupation: 'PT' , alignment_type_id: '3')
...
afc2 = ApplicationForm.create(candidate: c2,training_center_id: t1,course_id: CourseType.where(course_type: 'HS').first.id, aha_instructor_motivation: 'Because  my passion is to teach HS', experience_check: 'Yes', experience_description: 'Experience include.....', marketing_origin: 'Online',teaching_frequency: '2 weeks', owned_equipment: 'No' ,
...
ApplicationForm.create(candidate: c2,training_center_id: t1,course_id: CourseType.where(course_type: 'BLS').first.id, aha_instructor_motivation: 'Because  my passion is to teach BLS' , experience_check: 'Yes', experience_description: 'Experience include.....', marketing_origin: 'Online',teaching_frequency: '2 weeks', owned_equipment: 'No' ,
                       public_class_availability: 'No', teaching_location: 'Yes', screening_form_agreement: 'No' , date_agreed: DateTime.strptime('04/28/2017', "%m/%d/%Y") , aha_form_agreement: 'No' )
ApplicationForm.create(candidate: c2,training_center_id: t1,course_id: CourseType.where(course_type: 'ACLS').first.id, aha_instructor_motivation: 'Because my passion is to teach ACLS', experience_check: 'Yes', experience_description: 'Experience include.....', marketing_origin: 'Online',teaching_frequency: '2 weeks', owned_equipment: 'No' ,
                       public_class_availability: 'No', teaching_location: 'Yes', screening_form_agreement: 'No' , date_agreed: DateTime.strptime('04/28/2017', "%m/%d/%Y") , aha_form_agreement: 'No' )

afc3 = ApplicationForm.create(candidate: c3,training_center_id: t1,course_id: CourseType.where(course_type: 'HS').first.id, aha_instructor_motivation: 'Because  my passion is to teach HS', experience_check: 'Yes', experience_description: 'Experience include.....', marketing_origin: 'Family',teaching_frequency: '1 weeks', owned_equipment: 'Yes' ,
...
ApplicationForm.create(candidate: c3,training_center_id: t1,course_id: CourseType.where(course_type: 'BLS').first.id, aha_instructor_motivation: 'Because  my passion is to teach HS', experience_check: 'Yes', experience_description: 'Experience include.....', marketing_origin: 'Family',teaching_frequency: '1 weeks', owned_equipment: 'Yes' ,
                       public_class_availability: 'No', teaching_location: 'Yes', screening_form_agreement: 'No' , date_agreed: DateTime.strptime('05/1/2017', "%m/%d/%Y") , aha_form_agreement: 'Yes' )
ApplicationForm.create(candidate: c3,training_center_id: t1,course_id: CourseType.where(course_type: 'ACLS').first.id, aha_instructor_motivation: 'Because  my passion is to teach HS', experience_check: 'Yes', experience_description: 'Experience include.....', marketing_origin: 'Family',teaching_frequency: '1 weeks', owned_equipment: 'Yes' ,
                       public_class_availability: 'No', teaching_location: 'Yes', screening_form_agreement: 'No' , date_agreed: DateTime.strptime('05/1/2017', "%m/%d/%Y") , aha_form_agreement: 'Yes' )
...
afc1 = ApplicationForm.create(candidate: c1,training_center_id: t1,course_id: CourseType.where(course_type: 'BLS').first.id, aha_instructor_motivation: 'Because my passion is to teach BLS', experience_check: 'Yes', experience_description: 'Experience include.....', marketing_origin: 'Friend',teaching_frequency: '1 weeks', owned_equipment: 'Yes' ,
...
ApplicationForm.create(candidate: c1,training_center_id: t1,course_id: CourseType.where(course_type: 'ACLS').first.id, aha_instructor_motivation: 'Because my passion is to teach ACLS', experience_check: 'Yes', experience_description: 'Experience include.....', marketing_origin: 'Friend',teaching_frequency: '1 weeks', owned_equipment: 'Yes' ,
                       public_class_availability: 'No', teaching_location: 'Yes', screening_form_agreement: 'No' , date_agreed: DateTime.strptime('04/26/2017', "%m/%d/%Y") , aha_form_agreement: 'Yes' )
ApplicationForm.create(candidate: c1,training_center_id: t1,course_id: CourseType.where(course_type: 'HS').first.id, aha_instructor_motivation: 'Because my passion is to teach HS', experience_check: 'Yes', experience_description: 'Experience include.....', marketing_origin: 'Friend',teaching_frequency: '1 weeks', owned_equipment: 'Yes' ,
                       public_class_availability: 'No', teaching_location: 'Yes', screening_form_agreement: 'No' , date_agreed: DateTime.strptime('04/26/2017', "%m/%d/%Y") , aha_form_agreement: 'Yes' )

afc4 = ApplicationForm.create(candidate: c4,training_center_id: t1,course_id: CourseType.where(course_type: 'BLS').first.id, aha_instructor_motivation: 'Because my passion is to teach BLS ', experience_check: 'Yes', experience_description: 'Experience include.....', marketing_origin: 'Friend',teaching_frequency: '3 weeks', owned_equipment: 'Yes' ,
...
ApplicationForm.create(candidate: c4,training_center_id: t1,course_id: CourseType.where(course_type: 'HS').first.id, aha_instructor_motivation: 'Because my passion is to teach HS ', experience_check: 'Yes', experience_description: 'Experience include.....', marketing_origin: 'Friend',teaching_frequency: '3 weeks', owned_equipment: 'Yes' ,
                       public_class_availability: 'No', teaching_location: 'Yes', screening_form_agreement: 'No' , date_agreed: DateTime.strptime('04/29/2017', "%m/%d/%Y") , aha_form_agreement: 'Yes' )
ApplicationForm.create(candidate: c4,training_center_id: t1,course_id: CourseType.where(course_type: 'ACLS').first.id, aha_instructor_motivation: 'Because my passion is to teach ACLS ', experience_check: 'Yes', experience_description: 'Experience include.....', marketing_origin: 'Friend',teaching_frequency: '3 weeks', owned_equipment: 'Yes' ,
                       public_class_availability: 'No', teaching_location: 'Yes', screening_form_agreement: 'No' , date_agreed: DateTime.strptime('04/29/2017', "%m/%d/%Y") , aha_form_agreement: 'Yes' )
...
Appointment.create(start: '2017-4-12 10:00:00', end:'2017-4-12 11:00:00',  faculty_id:f3.id,  title:'Appt. for Jessie Klein with Ashley Michael', application_form_id:afc1.id)
Appointment.create(start: '2017-4-14 12:00:00', end:'2017-4-14 13:00:00',  faculty_id:f3.id,  title:'Appt. for Sarah Johan with Ashley Michael', application_form_id:afc2.id)
Appointment.create(start: '2017-4-15 13:00:00', end:'2017-4-15 14:00:00',  faculty_id:f3.id,  title:'Appt. for David Jacques with Ashley Michael', application_form_id:afc3.id)
Appointment.create(start: '2017-4-16 10:00:00', end:'2017-4-16 11:00:00',  faculty_id:f3.id,  title:'Appt. for Michelle Sasser with Ashley Michael', application_form_id:afc4.id)
Appointment.create(start: '2017-4-16 15:00:00', end:'2017-4-16 16:00:00',  faculty_id:f3.id,  title:'Appt. for Allison Castilliano with Ashley Michael', application_form_id:afc5.id)

# f2 time slot appointments
Appointment.create(start: '2017-4-13 11:00:00', end:'2017-4-13 12:00:00',  faculty_id:f2.id,  title:'Appt. for Alex Capont with Jessica Sheng', application_form_id:afc9.id)
Appointment.create(start: '2017-4-13 14:00:00', end:'2017-4-13 15:00:00',  faculty_id:f2.id,  title:'Appt. for Alex Capont with Jessica Sheng', application_form_id:afc9.id)
Appointment.create(start: '2017-4-15 9:00:00',  end:'2017-4-15 10:00:00',  faculty_id:f2.id,  title:'Appt. for Alex Capont with Jessica Sheng', application_form_id:afc9.id)
Appointment.create(start: '2017-4-16 11:00:00', end:'2017-4-16 12:00:00',  faculty_id:f2.id,  title:'Appt. for Alex Capont with Jessica Sheng', application_form_id:afc9.id)
Appointment.create(start: '2017-4-16 15:00:00', end:'2017-4-16 16:00:00',  faculty_id:f2.id,  title:'Appt. for Joseph Mandell with Jessica Sheng', application_form_id:afc10.id)

# f1 time slot appointments
Appointment.create(start: '2017-4-14 11:00:00', end:'2017-4-14 12:00:00',  faculty_id:f1.id,  title:'Appt. for Jessie Klein with Cheri Berry', application_form_id:afc1.id)
Appointment.create(start: '2017-4-13 14:00:00', end:'2017-4-13 15:00:00',  faculty_id:f1.id,  title:'Appt. for Sarah Johan with Cheri Berry', application_form_id:afc2.id)
Appointment.create(start: '2017-4-15 13:00:00', end:'2017-4-15 14:00:00',  faculty_id:f1.id,  title:'Appt. for David Jacques with Cheri Berry', application_form_id:afc3.id)
Appointment.create(start: '2017-4-18 10:00:00', end:'2017-4-18 11:00:00',  faculty_id:f1.id,  title:'Appt. for Michelle Sasser with Cheri Berry', application_form_id:afc4.id)
Appointment.create(start: '2017-4-17 15:00:00', end:'2017-4-17 16:00:00',  faculty_id:f1.id,  title:'Appt. for Allison Castilliano with Cheri Berry', application_form_id:afc5.id)
