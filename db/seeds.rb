...
ApplicationForm.create(candidate: c2,training_center_id: t1.id, aha_instructor_motivation: 'Because  my passion is to teach BLS' , experience_check: 'Yes', experience_description: 'Experience include.....', marketing_origin: 'Online',teaching_frequency: '2 weeks', owned_equipment: 'No' ,
                       public_class_availability: 'No', teaching_location: 'Yes', screening_form_agreement: 'No' , date_agreed: DateTime.strptime('04/28/2017', "%m/%d/%Y") , aha_form_agreement: 'No', course_type_id: 2, cpr_instructor_check: 'Yes', aha_check: 'No',  merica_cross_check: 'Yes', ns_council_other: ' ',
...
ApplicationForm.create(candidate: c2,training_center_id: t1.id, aha_instructor_motivation: 'Because my passion is to teach ACLS', experience_check: 'Yes', experience_description: 'Experience include.....', marketing_origin: 'Online',teaching_frequency: '2 weeks', owned_equipment: 'No' ,
                       public_class_availability: 'No', teaching_location: 'Yes', screening_form_agreement: 'No' , date_agreed: DateTime.strptime('04/28/2017', "%m/%d/%Y") , aha_form_agreement: 'No', course_type_id: 3, cpr_instructor_check: 'Yes', aha_check: 'No',  merica_cross_check:  'Yes', ns_council_other: ' ',
...
ApplicationForm.create(candidate: c3,training_center_id: t1, aha_instructor_motivation: 'Because  my passion is to teach HS', experience_check: 'Yes', experience_description: 'Experience include.....', marketing_origin: 'Family',teaching_frequency: '1 weeks', owned_equipment: 'Yes' ,
                       public_class_availability: 'No', teaching_location: 'Yes', screening_form_agreement: 'No' , date_agreed: DateTime.strptime('05/1/2017', "%m/%d/%Y") , aha_form_agreement: 'Yes', course_type_id: 2, cpr_instructor_check: 'Yes', aha_check: 'Yes', aha_training_canter:' ' , merica_cross_check: 'Yes', ns_council_other: ' ',
...
ApplicationForm.create(candidate: c3,training_center_id: t1, aha_instructor_motivation: 'Because  my passion is to teach HS', experience_check: 'Yes', experience_description: 'Experience include.....', marketing_origin: 'Family',teaching_frequency: '1 weeks', owned_equipment: 'Yes' ,
                       public_class_availability: 'No', teaching_location: 'Yes', screening_form_agreement: 'No' , date_agreed: DateTime.strptime('05/1/2017', "%m/%d/%Y") , aha_form_agreement: 'Yes', course_type_id: 3, cpr_instructor_check: 'Yes', aha_check: 'Yes', aha_training_canter:' ' , merica_cross_check: 'Yes', ns_council_other: ' ',
...
afc5 = ApplicationForm.create(candidate: c5,training_center_id: t1, aha_instructor_motivation: 'Because my passion is to teach BLS', experience_check: 'Yes', experience_description: 'Experience include.....', marketing_origin: 'Online',teaching_frequency: '1 weeks', owned_equipment: 'Yes' ,
                       public_class_availability: 'No', teaching_location: 'Yes', screening_form_agreement: 'No' , date_agreed: DateTime.strptime('05/2/2017', "%m/%d/%Y") , aha_form_agreement: 'Yes', course_type_id: 1, cpr_instructor_check: 'No', aha_check: 'Yes', aha_training_canter:' ' , merica_cross_check: 'Yes', ns_council_other: ' ',
...
afc1 = ApplicationForm.create(candidate: c1,training_center_id: t1, aha_instructor_motivation: 'Because my passion is to teach BLS', experience_check: 'Yes', experience_description: 'Experience include.....', marketing_origin: 'Friend',teaching_frequency: '1 weeks', owned_equipment: 'Yes' ,
                       public_class_availability: 'No', teaching_location: 'Yes', screening_form_agreement: 'No' , date_agreed: DateTime.strptime('04/26/2017', "%m/%d/%Y") , aha_form_agreement: 'Yes', course_type_id: 3, cpr_instructor_check: 'No', aha_check: 'Yes', aha_training_canter: ' ', merica_cross_check: 'Yes', ns_council_other: ' ',
...
ApplicationForm.create(candidate: c1,training_center_id: t1, aha_instructor_motivation: 'Because my passion is to teach ACLS', experience_check: 'Yes', experience_description: 'Experience include.....', marketing_origin: 'Friend',teaching_frequency: '1 weeks', owned_equipment: 'Yes' ,
                       public_class_availability: 'No', teaching_location: 'Yes', screening_form_agreement: 'No' , date_agreed: DateTime.strptime('04/26/2017', "%m/%d/%Y") , aha_form_agreement: 'Yes', course_type_id: 4, cpr_instructor_check: 'No', aha_check: 'Yes', aha_training_canter: ' ', merica_cross_check: 'Yes', ns_council_other: ' ',
